...
The adaptive channel descriptor vector $\mathbf{z}_{\mathrm{adaptive}} = [z_1, \dots, z_C]$ 

replaces the GAP output in the SE formulation $\mathbf{s} = \sigma\!\left(W_2 \, \delta(W_1 \mathbf{z}_{\mathrm{adaptive}})\right)$.
